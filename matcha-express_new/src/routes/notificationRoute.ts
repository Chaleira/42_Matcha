...
router.post('/create', validateQueryParams(null), validateBodyParams(['triggered_by_id', 'type', 'content'], ['triggered_by_id', 'type', 'content']), catchAsync(notificationController.createNotification));
router.post('/update', validateQueryParams(['id'], ['id']), validateBodyParams(['triggered_by_id', 'type', 'content', 'seen']), catchAsync(notificationController.updateNotification));
